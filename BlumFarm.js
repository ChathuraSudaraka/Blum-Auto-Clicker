...
try {
    ...
    .settings-menu {
        ...
        background: linear-gradient(145deg, rgba(29, 29, 29, 0.95), rgba(23, 23, 23, 0.95));
        border-radius: 20px;
    ...
    .settings-button {
        ...
        bottom: 160px;
        right: 30px;
        background: linear-gradient(145deg, #227725, #1b5e1e);
        border: none;
        border-radius: 16px;
        width: 52px;
        height: 52px;
        font-size: 24px;
        cursor: pointer;
        box-shadow: 0 8px 24px rgba(34, 119, 37, 0.3);
        transition: all 0.3s;
        z-index: 999999;
        display: flex;
        align-items: center;
    ...
    .settings-button:hover {
        ...
        box-shadow: 0 12px 28px rgba(34, 119, 37, 0.4);
    }
